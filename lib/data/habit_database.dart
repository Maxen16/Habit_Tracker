...
class HabitDatabase {
  ...
  void loadData() {
    // if it is a new day, get habitlist from database
  ...
  void calculateHabitPercentage() {
   ...
   //value: string od 1 decimal place no between 0.0 and 1.0
  ...
  void loadHeatMap() {
    ...
    //go from start date to today and add each percentage
